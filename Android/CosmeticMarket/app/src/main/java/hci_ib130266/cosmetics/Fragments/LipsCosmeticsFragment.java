...
public class LipsCosmeticsFragment extends Fragment {
    ...
    public LipsCosmeticsFragment() {

    }

    public static LipsCosmeticsFragment newInstance() {
        LipsCosmeticsFragment fragment = new LipsCosmeticsFragment();
    ...
    private void doGetData() {
        ...
        }.execute(NetworkUtils.buildSearchURL(mSearchQuery,3));

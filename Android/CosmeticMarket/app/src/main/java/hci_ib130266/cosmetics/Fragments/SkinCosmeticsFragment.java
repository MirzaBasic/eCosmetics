...
public class SkinCosmeticsFragment extends Fragment {
    ...
    public SkinCosmeticsFragment() {

    }

    public static SkinCosmeticsFragment newInstance() {
        SkinCosmeticsFragment fragment = new SkinCosmeticsFragment();
    ...
    private void doGetData() {
        ...
        }.execute(NetworkUtils.buildSearchURL(mSearchQuery,4));

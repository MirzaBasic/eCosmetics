...
public class EyesCosmeticsFragment extends Fragment {
    ...
    public EyesCosmeticsFragment() {

    }

    public static EyesCosmeticsFragment newInstance() {
        EyesCosmeticsFragment fragment = new EyesCosmeticsFragment();

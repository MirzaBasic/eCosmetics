package hci_ib130266.cosmetics.Activitys;
        ...
        mListView.setAdapter(new BaseAdapter() {
            ...
            public View getView(int position, View view, ViewGroup parent) {
                ...
                if(stavka.Proizvod.Popust!=0){
                    cijena.setText("Cijena: "+String.valueOf(stavka.Proizvod.Cijena*stavka.Proizvod.Popust/100)+" KM");
                }
                else{
                    cijena.setText("Cijena: "+String.valueOf(stavka.Proizvod.Cijena)+" KM");
                }

              naziv.setText("Naziv: "+stavka.Proizvod.Naziv+" ("+stavka.Proizvod.Sifra+")");

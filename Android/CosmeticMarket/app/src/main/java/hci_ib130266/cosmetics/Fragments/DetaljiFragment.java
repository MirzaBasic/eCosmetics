...
import hci_ib130266.cosmetics.Helper.MyApp;

import hci_ib130266.cosmetics.Helper.Sesija;

import hci_ib130266.cosmetics.Models.Global;
import hci_ib130266.cosmetics.Models.KomentariVM;
import hci_ib130266.cosmetics.Models.NaruzbeVM;

import hci_ib130266.cosmetics.Models.ProizvodiVM;
import hci_ib130266.cosmetics.Models.StavkeNarudzbeVM;
 ...
 */
public class DetaljiFragment extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
     view   = inflater.inflate(R.layout.fragment_detalji_proizvoda, container, false);
        ...
        if (arg.containsKey("proizvod_key")) {
          ...
          getDialog().setTitle(proizvod.Naziv);
            ...
            public View getView(int position, View view, ViewGroup parent) {
                ...
                if((position+1)==komentari.size()){
                    ...
                    btnAddComment.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                             if(!txtComent.getText().toString().equals("")){
                ...
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (!proizvodVecUKorpi) {
                            ...
                            stavka.Proizvod.Sifra=proizvod.Sifra;
